import { M as MotionGlobalConfig, q as noop, f as clamp, r as pipe, p as millisecondsToSeconds, u as secondsToMilliseconds, v as velocityPerSecond, i as invariant, s as progress, k as isEasingArray, h as easingDefinitionToFunction, g as easeInOut, o as memo, j as isBezierDefinition, d as circInOut, c as backInOut, b as anticipate, S as SubscriptionManager, l as isNumericalString, n as isZeroValueString, m as isObject, e as circOut, a as addUniqueItem, t as removeItem } from "./motion-utils.mjs";
const stepsOrder = [
  "setup",
  // Compute
  "read",
...
export {
  ...
  Feature as F,
  microtask as G,
  HTMLProjectionNode as H,
  mixNumber$1 as I,
  motionValue as J,
  optimizedAppearDataAttribute as K,
  percent as L,
  press as M,
  resize as N,
  resolveElements as O,
  resolveMotionValue as P,
  resolveVariant as Q,
  resolveVariantFromProps as R,
  SVGVisualElement as S,
  scrapeMotionValuesFromProps$1 as T,
  scrapeMotionValuesFromProps as U,
  setDragLock as V,
  setFeatureDefinitions as W,
  transform as X,
  HTMLVisualElement as a,
  addDomEvent as b,
  addValueToWillChange as c,
  animateMotionValue as d,
  attachFollow as e,
  buildHTMLStyles as f,
  buildSVGAttrs as g,
  calcLength as h,
  cancelFrame as i,
  collectMotionValues as j,
  convertBoundingBoxToBox as k,
  convertBoxToBoundingBox as l,
  createAnimationState as m,
  createBox as n,
  eachAxis as o,
  frame as p,
  frameData as q,
  getFeatureDefinitions as r,
  globalProjectionState as s,
  hover as t,
  isAnimationControls as u,
  isControllingVariants as v,
  isElementTextInput as w,
  isForcedMotionValue as x,
  isHTMLElement as y,
  isMotionValue as z
};
