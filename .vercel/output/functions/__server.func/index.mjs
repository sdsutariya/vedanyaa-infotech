...
import { a as HTTPError, d as defineLazyEventHandler, H as H3Core, t as toRequest } from "./_libs/h3.mjs";
...
const _lazy_UeXCoG = defineLazyEventHandler(() => Promise.resolve().then(function() {
  return ssrRenderer$1;
}));
const findRoute = /* @__PURE__ */ (() => {
  const data = { route: "/**", handler: _lazy_UeXCoG };
  return ((_m, p) => {
