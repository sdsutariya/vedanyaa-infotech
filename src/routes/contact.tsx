      ...
      <section className="relative py-24 border-b border-border/60 bg-hero overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
          <Reveal>
            ...
            <h1 className="font-display text-5xl md:text-7xl max-w-4xl">Let's build something <span className="italic text-gradient-gold">remarkable together.</span></h1>
            <p className="mt-6 max-w-2xl text-muted-foreground text-lg">Share a few details about your project and we'll respond within one business day.</p>
          </Reveal>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-5 gap-12">
          <Reveal className="lg:col-span-2">
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={c.label} className="flex gap-4 p-5 rounded-xl border border-border bg-card hover:border-gold/30 transition-all duration-300">
                  ...
                  <div>
                    <div className="text-[10px] uppercase tracking-[0.25em] text-gold">{c.label}</div>
            ...
            <div className="mt-10 p-6 rounded-xl border border-gold/30 bg-gold/5">
              <div className="text-xs uppercase tracking-[0.3em] text-gold mb-2">Response Promise</div>
              <p className="text-sm text-muted-foreground">Every enquiry is reviewed by a senior engineer and answered within 24 hours.</p>
            </div>
          </Reveal>
            ...
            >
              {sent ? (
                <div className="text-center py-16">
                  ...
                  <p className="mt-3 text-muted-foreground">We've received your message and will reply within 24 hours.</p>
                </div>
              ) : (
                <div className="space-y-6">
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    ...
                    <Field label="Service of Interest" name="service" placeholder="e.g. Custom ERP" />
                  </div>
                  <div>
                    <label className="block text-xs uppercase tracking-[0.25em] text-gold mb-2">Project Details</label>
                    <textarea required rows={5} className="w-full px-4 py-3 rounded-md bg-background/60 border border-border focus:border-gold focus:outline-none transition-colors text-foreground" />
                  </div>
                  <button type="submit" className="group inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-gold text-primary-foreground text-sm uppercase tracking-wider hover:shadow-gold transition-all duration-300">
