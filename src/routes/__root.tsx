    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <a
            href="/"
            className="inline-flex items-center px-5 py-2.5 rounded-md bg-gold text-primary-foreground text-sm uppercase tracking-wider hover:opacity-90"
          >
            Return Home
          </a>
        </div>
      ...
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex justify-center gap-2">
          <button
            ...
            className="px-5 py-2.5 rounded-md bg-gold text-primary-foreground text-sm uppercase tracking-wider"
          >
            Try again
          </button>
          <a
            href="/"
            className="px-5 py-2.5 rounded-md border border-border text-sm uppercase tracking-wider"
          >
            Home
          </a>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Vedanyaa Infotech" },
      {
        name: "keywords",
        content:
          "Vedanyaa Infotech, software development company, ERP development, MERN stack, Next.js, Nest.js, PHP development, AI-driven applications, e-commerce development, custom software, web development India",
      },
      {
        name: "robots",
      ...
      {
        property: "og:title",
        content: "Vedanyaa Infotech — Premium Software, ERP & Web Development Company",
      },
      {
        property: "og:description",
        content:
          "Trusted partner for MERN, Next.js, AI-driven apps, e-commerce and custom ERP development.",
      },
      ...
      { name: "twitter:title", content: "Vedanyaa Infotech — Software & ERP Development" },
      {
        ...
        content: "Boutique software studio engineering reliable digital products.",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          logo: "/favicon.png",
          description:
            "Software development company specializing in PHP, MERN, Next.js, Nest.js, AI-driven applications, e-commerce and custom ERP.",
          sameAs: [],
          contactPoint: {
            "@type": "ContactPoint",
