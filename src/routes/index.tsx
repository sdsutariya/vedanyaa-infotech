  ...
  head: () => ({
    meta: [
      { title: "Vedanyaa Infotech — Premium Web, MERN, Next.js & ERP Development Company" },
      {
        name: "description",
        content:
          "Vedanyaa Infotech is a trusted software studio delivering PHP, MERN, Next.js, AI-driven apps, e-commerce and custom ERP solutions for businesses worldwide.",
      },
      {
        name: "keywords",
        content:
          "software development company, ERP development company, MERN stack development, Next.js development, AI driven applications, e-commerce development, custom ERP, Vedanyaa Infotech",
      },
      {
        property: "og:title",
      ...
      },
      {
        ...
        content:
          "Boutique software studio engineering reliable digital products — MERN, Next.js, AI, e-commerce, ERP.",
      },
      ...
      <section className="relative min-h-[100dvh] flex items-center overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <img
            src={heroBg}
            alt=""
            className="w-full h-full object-cover opacity-[0.08] dark:opacity-30"
            width={1920}
            height={1280}
          />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 py-32 grid lg:grid-cols-12 gap-12 items-center w-full relative z-10">
          <div className="lg:col-span-7">
            ...
            >
              ...
              MERN & Next.js applications, e-commerce experiences, and custom ERP systems for
              businesses that demand more than ordinary.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <Link
                to="/contact"
                className="group inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-gold text-primary-foreground text-sm uppercase tracking-wider font-medium hover:shadow-gold transition-all duration-300"
              >
                Start a Project{" "}
              ...
              <Link
                to="/services"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-xl border border-border text-sm uppercase tracking-wider text-foreground hover:border-gold hover:text-gold transition-all duration-300"
              >
                Explore Services
              </Link>
            </motion.div>
            ...
            <div className="relative w-[400px] h-[400px]">
              ...
              <div className="absolute inset-16 rounded-full bg-gradient-to-br from-card to-muted border border-border flex items-center justify-center shadow-elegant">
                <div className="text-center">
                  ...
                  <div className="mt-2 text-[10px] uppercase tracking-[0.4em] text-gold">
                    Est. Excellence
                  </div>
                </div>
              </div>
          ...
          <Reveal>
            <div className="max-w-3xl">
              ...
              <h2 className="font-display text-4xl md:text-6xl">
                A complete suite of{" "}
                <span className="italic text-gradient-gold">digital craftsmanship</span>
              </h2>
              <p className="mt-6 text-muted-foreground text-lg leading-relaxed">
                From bespoke ERP systems to lightning-fast e-commerce, our work blends engineering
                rigor with classic design sensibilities.
              </p>
            </div>
          </Reveal>
              ...
              <Reveal key={s.title} delay={i * 0.05}>
                <div className="group h-full p-8 rounded-2xl border border-border bg-card relative overflow-hidden hover:border-gold/40 hover:-translate-y-1.5 transition-all duration-500 shadow-elegant/30 hover:shadow-elegant">
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "radial-gradient(600px circle at var(--mouse-x, 50%) var(--mouse-y, 50%), oklch(0.45 0.18 268 / 0.12), transparent 40%)",
                    }}
                  />
                  <div className="relative z-10">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {s.points.slice(0, 3).map((pt) => (
                        <span
                          key={pt}
                          className="text-[10px] uppercase tracking-wider px-3 py-1 rounded-full bg-muted border border-border text-muted-foreground"
                        >
                          {pt}
                        </span>
                      ))}
          ...
          <Reveal>
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <h2 className="font-display text-4xl md:text-5xl">
                Built on trust.{" "}
                <span className="italic text-gradient-gold">Engineered to last.</span>
              </h2>
            </div>
          </Reveal>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <Reveal>
            <div className="text-center max-w-2xl mx-auto">
              ...
              <h2 className="font-display text-4xl md:text-5xl">
                Methodical. Transparent. <span className="italic text-gradient-gold">Refined.</span>
              </h2>
            </div>
          </Reveal>
      ...
      <section className="py-28 relative overflow-hidden">
        <div className="absolute inset-0 opacity-[0.03] pointer-events-none">
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle at 20% 50%, oklch(0.45 0.18 268), transparent 50%), radial-gradient(circle at 80% 50%, oklch(0.62 0.15 165), transparent 50%)",
            }}
          />
        </div>
        <div className="max-w-4xl mx-auto px-6 lg:px-10 text-center relative z-10">
          <Reveal>
            ...
            <p className="font-display text-2xl md:text-3xl leading-relaxed italic text-foreground">
              Vedanyaa delivered our ERP platform on time, on budget, and with a level of polish we
              hadn't seen from other vendors. They feel like an extension of our own team.
            </p>
          ...
          <Reveal>
            <div className="relative rounded-3xl p-12 md:p-20 border border-gold/30 bg-gradient-to-br from-navy via-card to-navy-deep overflow-hidden">
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle, oklch(0.45 0.18 268 / 0.5), transparent 70%)",
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle, oklch(0.62 0.15 165 / 0.4), transparent 70%)",
              ...
              <div className="relative grid md:grid-cols-3 gap-10 items-center z-10">
                <div className="md:col-span-2">
                  ...
                  <p className="mt-4 text-muted-foreground text-lg">
                    Let's discuss your project. Free consultation, transparent estimate.
                  </p>
                  <div className="mt-6 flex flex-wrap gap-3">
                    {["Free Consultation", "NDA Available", "24h Response"].map((tag) => (
                      <span
                        key={tag}
                        className="inline-flex items-center gap-1.5 text-xs uppercase tracking-wider px-4 py-2 rounded-full border border-gold/30 text-gold"
                      >
                ...
                <div className="md:justify-self-end">
                  <Link
                    to="/contact"
                    className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-gold text-primary-foreground text-sm uppercase tracking-wider hover:shadow-gold transition-all duration-300"
                  >
