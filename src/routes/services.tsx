  ...
  head: () => ({
    meta: [
      { title: "Services — PHP, MERN, Next.js, AI & ERP Development | Vedanyaa Infotech" },
      {
        name: "description",
        content:
          "Explore Vedanyaa Infotech's services: PHP, MERN, Next.js, Nest.js, AI-driven apps, e-commerce, corporate websites and custom ERP development.",
      },
      {
        name: "keywords",
        content:
          "PHP development services, MERN stack services, Next.js development, AI development services, ERP development services, e-commerce development",
      },
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
          <Reveal>
            ...
            <h1 className="font-display text-5xl md:text-7xl max-w-4xl">
              ...
              <span className="italic text-gradient-gold">tailored to your ambition.</span>
            </h1>
            <p className="mt-6 max-w-2xl text-muted-foreground text-lg">
              A focused offering of nine disciplines, each delivered with the same attention to
              detail, security and craft.
            </p>
          </Reveal>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 space-y-10">
          {services.map((s, i) => (
            <Reveal key={s.title} delay={0.05}>
              <div
                className={`grid md:grid-cols-12 gap-10 p-10 md:p-14 rounded-2xl border border-border bg-card hover:border-gold/40 hover:-translate-y-1 hover:shadow-elegant transition-all duration-500 ${i % 2 === 1 ? "md:flex-row-reverse" : ""}`}
              >
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-10 text-center">
          <Reveal>
            ...
            <p className="mt-4 text-muted-foreground text-lg">
              Tell us about your goals. We'll send back a clear roadmap and estimate.
            </p>
            <Link
              to="/contact"
              className="mt-8 inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-gold text-primary-foreground text-sm uppercase tracking-wider hover:shadow-gold transition-all duration-300"
            >
